...
class WorklistInformation(models.Model):
    ...
    #scheduled_procedure_step_start_date = models.DateField(default=datetime.datetime.today())
    #scheduled_procedure_step_start_time  = models.DateField(default=datetime.datetime.today())

    # scheduled_procedure_step_start_date = models.DateTimeField(auto_now_add=True)
    # scheduled_procedure_step_start_time  = models.DateTimeField(auto_now_add=True)
